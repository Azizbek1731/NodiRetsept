'use strict';
/** Yengil SVG ikonkalar to'plami (stroke, 24×24) — tashqi kutubxonasiz. */
const P = {
  dashboard: '<rect x="3" y="3" width="7" height="9" rx="1.5"/><rect x="14" y="3" width="7" height="5" rx="1.5"/><rect x="14" y="12" width="7" height="9" rx="1.5"/><rect x="3" y="16" width="7" height="5" rx="1.5"/>',
  users: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
  user: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  rx: '<path d="M5 21V8h4.5a3.5 3.5 0 0 1 0 7H5"/><path d="M9.5 15 15 21"/><path d="m14 14 6 6M20 14l-6 6"/><path d="M5 8V4a1 1 0 0 1 1-1h9l4 4"/>',
  pill: '<path d="M10.5 20.5a5 5 0 0 1-7-7l7-7a5 5 0 0 1 7 7z"/><path d="m8.5 8.5 7 7"/>',
  plus: '<path d="M12 5v14M5 12h14"/>',
  search: '<circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/>',
  qr: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM18 18h3v3h-3zM14 21h1M21 14h-1"/>',
  ...
  stamp: '<path d="M6 21h12M9 12V7a3 3 0 1 1 6 0v5"/><path d="M5 18h14a0 0 0 0 0 0 0v-2a3 3 0 0 0-3-3H8a3 3 0 0 0-3 3v2z"/>',
  ...
  building: '<path d="M3 21h18M5 21V7l7-4 7 4v14"/><path d="M9 21v-6h6v6M9 10h.01M15 10h.01"/>',
  ...
  key: '<path d="M21 2 15 8"/><path d="m18 5 3 3"/><circle cx="8.5" cy="15.5" r="5.5"/><path d="m12.5 11.5 3-3"/>',
};

/**
 * @param {string} name ikonka nomi
...
function icon(name, opts = {}) {
  ...
  return `<svg${cls} width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" ` +
    `stroke="currentColor" stroke-width="${opts.stroke || 1.8}" stroke-linecap="round" ` +
